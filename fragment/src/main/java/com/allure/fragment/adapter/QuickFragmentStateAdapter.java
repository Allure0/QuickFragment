 ...
 * <pre>
 *
 * Using a large number of fragment in viewpager,use less memory
 */
public class QuickFragmentStateAdapter extends FragmentStatePagerAdapter {

    private List<Fragment> fragmentList = new ArrayList<Fragment>();
    private List<String> mTitles;

    public QuickFragmentStateAdapter(FragmentManager fm) {
        super(fm);
    }

    public QuickFragmentStateAdapter(FragmentManager fm, List<Fragment> fragmentList) {
        super(fm);
        this.fragmentList = fragmentList;
    }

    public QuickFragmentStateAdapter(FragmentManager fm, List<Fragment> fragmentList, List<String> mTitles) {
        super(fm);
